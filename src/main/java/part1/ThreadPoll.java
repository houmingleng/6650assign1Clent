...
public class ThreadPoll {
    ...
    public ThreadPoll(Integer totalReq, String IPAddress, Integer resortID, String dayID, String seasonID,
                      ...
                      AtomicInteger failCallCount, ThreadPoolExecutor es, ThreadPoolExecutor es2, AtomicInteger finished, CountDownLatch latch, int producernumber, int comsumernumber, AtomicInteger successproduce) {
    ...
    public  void beginPhase() throws InterruptedException{
        ...
        for(int i = 0; i < comsumernumber; i++) {
            ...
            es.execute(new Consumer(1000,IPAddress,queue,1000,successCallCount,failCallCount,finished));
