...
public class SingleThread implements Runnable{
    ...
    public SingleThread(Integer totalRideLiftCall, String IPAddress, Integer resortID,
                        ...
                        AtomicInteger successCallCount, AtomicInteger failCallCount,CopyOnWriteArrayList<List<Record>> recordList
                        ) {
    ...
    @Override
    public void run() {
        String url = "http://35.90.188.162:8080/upiServlet_war/";
